...
public class NguoiPhuTrach {
    ...
    public NguoiPhuTrach(int maNPT, String hoTen, Date namSinh, String queQuan, String hocVi, String chucVu, String SDT, String email, DiaPhuong diaPhuong, int active) {
        this.maNPT = maNPT;
        this.hoTen = hoTen;
