        ...
        <div class="col-lg-2 col-sm-2 col-md-2">
            ...
            <div class="panel panel-default">
                <div class="panel panel-collapse" style="background:#269abc;color:white ">
                    <h5 style="color:white"><b><span class="glyphicon glyphicon-th-list"></span>&nbsp;Thông tin truyền thông</b></h5>
                </div>   
                <div class="panel panel-body">
                    <h6><b>Hội nghị sơ kết chương trình thí điểm nông thôn mới<b></h6>
                                <a href="#"><h6><span class="glyphicon glyphicon-check"></span>&nbsp;Hội nghị sơ kết chương trình thí điểm nông thôn mới</h6></a>           
                                <a href="#"><h6><span class="glyphicon glyphicon-check"></span>&nbsp;Hiệu quả từ việc dồn điền đổi thửa</h6></a>           
                                <a href="#"><h6><span class="glyphicon glyphicon-check"></span>&nbsp;Xây dựng nông thôn mới dựa vào cộng đồng</h6></a>           
